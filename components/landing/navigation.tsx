      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <img src="/placeholder-logo.png" alt="Stratium AI" className="w-7 h-7 rounded-full" />
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>Stratium</span>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className={`inline-flex items-center gap-1.5 rounded-full border transition-all duration-500 px-3 h-8 text-xs font-mono ${
                isScrolled
          ...
          <div className="flex items-center gap-2 md:hidden">
            <button
              onClick={toggleLang}
              aria-label={lang === "ru" ? "Switch to English" : "Переключить на русский"}
              className={`inline-flex items-center gap-1 rounded-full border px-2.5 h-8 text-xs font-mono transition-colors duration-500 ${
                isScrolled || isMobileMenuOpen
