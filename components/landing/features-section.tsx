          ...
          >
            ...
            <div className="relative flex-1 p-8 lg:p-12 bg-black">
              ...
              <div className="relative z-10">
                <span className="font-mono text-sm text-muted-foreground">{t.features.number}</span>
                <h3 className="text-3xl lg:text-4xl font-display mt-4 mb-6 group-hover:translate-x-2 transition-transform duration-500">
                  {t.features.cardTitle}
                </h3>
                <p className="text-lg text-muted-foreground leading-relaxed max-w-md mb-8">
                  {t.features.cardDesc}
                </p>
                <div>
                  <span className="text-5xl lg:text-6xl font-display">{t.features.statValue}</span>
                  <span className="block text-sm text-muted-foreground font-mono mt-2">{t.features.statLabel}</span>
                </div>
              </div>
            </div>
